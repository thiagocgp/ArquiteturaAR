...
namespace GoogleARCore.Examples.ObjectManipulation
{
    ...
    public class PawnManipulator : Manipulator
    {
        ...
        // Variable to check if already has one object in scene --- ArquiteturaAR
        private bool hasObjectInScene = false;
        ...
        // ArquiteturaAR
        public bool getHasObjectInScene()
        {
            return hasObjectInScene;
        }
    }
}
