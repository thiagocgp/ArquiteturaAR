...
namespace GoogleARCore.Examples.HelloAR
{
    ...
    public class HelloARController : MonoBehaviour
    {
        ...
        // ArquiteturaAR
        private float houseObjectScale;
        ...
        public void Update()
        {
            ...
            {
                if (GameObject.FindGameObjectWithTag("casa") == null)
                {
        ...
        private void _UpdateApplicationLifecycle()
        {
            ...
            {
                _ShowAndroidToastMessage("A permissão de acesso a câmera é necessária para rodar esta aplicação.");
                m_IsQuitting = true;
                Invoke("_DoQuit", 0.5f);
            }
            else if (Session.Status.IsError())
            {
                _ShowAndroidToastMessage(
                    "Um problema foi encontrado. Por favor inicie a aplicação novamente.");
                m_IsQuitting = true;
                Invoke("_DoQuit", 0.5f);
            }
        }
        ...
        public void ZoomIn()
        {
            ...
            if(houseObject != null)
            {
                switch (houseObjectScale)
                {
                    ...
                    case 0.02f:
                        houseObjectScale = 0.04f;
                        scaleText.text = "Escala: 1:25";
                        break;

                    case 0.04f:
                        houseObjectScale = 0.1f;
                        scaleText.text = "Escala: 1:10";
                        break;

                    case 0.1f:
                        houseObjectScale = 0.5f;
                        scaleText.text = "Escala: 1:2";
                        break;

                    case 0.5f:
                        houseObjectScale = 1.0f;
                        scaleText.text = "Escala: 1:1";
                        break;
                ...
                houseObject.transform.localScale = new Vector3(houseObjectScale, houseObjectScale, houseObjectScale);
            }
        }
